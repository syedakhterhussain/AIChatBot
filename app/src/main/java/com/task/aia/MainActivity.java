...
public class MainActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    private void fetchAIResponse(String query) {
        ...
        Call<GPTResponse> call = openAIService.getResponse("Bearer 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", new GPTRequest(query));
